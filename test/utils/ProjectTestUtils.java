...
public class ProjectTestUtils {
    ...
    public static CallInstruction findInvoke(OllirResult ollirResult, CallType invokeType) {
        return findInvoke(ollirResult, invokeType, 1).get(0);
    }

    public static List<CallInstruction> findInvoke(OllirResult ollirResult, CallType invokeType, int amount) {
        ...
        assertTrue(
                "Expected to find " + amount + " " + invokeType + ", instead found " + nodes.size() + ":\n"
